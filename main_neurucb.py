...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--num_episode", type=int, default=20, help="Total scenario episodes if num_scenario_repeats is not set.")
    parser.add_argument("--lap_period", type=int, default=400, help="Rendered policy-training steps per scenario episode.")
